...
title = "How to calibrate a 2D magnetometer with ellipsoid fitting"
tags = ["Roomba", "Robot", "Magnetometer"]
draft = false
description = "This jupyter-labs example shows how to calibrate noisy magnetometer data using ellipsoid fitting."
+++
