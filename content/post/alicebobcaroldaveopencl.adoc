...
"What is a cosine similarity" asked Alice? Can you please explain this? And Bob did.
...
but it can also run on the GPU(Graphics card) utilizing maybe 512 or 1024 of its
compute units. Using the GPU, heavy math can be greatly accelerated!.
...
have for instance 300 work items, and our GPU has 300 compute units, OpenCL can compute
