...
draft = false
description = "Netflix Hystrix is a very powerful framework to build fault tolerant and resilient applications. It provides common implementations for patterns like Timeout, http://martinfowler.com/bliki/CircuitBreaker.html[CircuitBreaker] and others. It also comes with nice monitoring capabilities using the Hystrix Dashboard or even JMX."
+++
