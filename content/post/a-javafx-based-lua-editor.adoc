...
Communicating between JavaScript and JavaFX with WebEngine: https://blogs.oracle.com/javafx/entry/communicating_between_javascript_and_javafx[Oracle Blog JavaFX JavaScript interaction]
